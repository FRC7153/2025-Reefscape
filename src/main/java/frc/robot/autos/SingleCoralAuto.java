...
public class SingleCoralAuto extends SequentialCommandGroup {
   ...
   */
  public SingleCoralAuto(SwerveDrive drive, Elevator elevator, Manipulator manipulator, LED led, String pathName, int reefSide, boolean repeatedly) {
    super(
      ...
      Util.possiblyRepeatedCommand(new ElevatorToStateCommand(elevator, ElevatorPositions.STOW), repeatedly)
    );
  ...
  public SingleCoralAuto(SwerveDrive drive, Elevator elevator, Manipulator manipulator, LED led, String pathName, int reefSide) {
    this(drive, elevator, manipulator, led, pathName, reefSide, true);
  }
